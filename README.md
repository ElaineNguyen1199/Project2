In Order to get this code to run for gui.py you must create a new foler named: "images" and have each png photo put into the images folder and put the "images" folder under
